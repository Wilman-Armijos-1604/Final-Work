...
import com.ticml.contabilidad.InformacionCuentaEmpresa
import com.ticml.contabilidad.R
import com.ticml.contabilidad.objetos.Cuenta

class Rcv_CuentaOrganizacion(
    private val context: Context,
    private val recyclerView: RecyclerView,
    private val list: List<Cuenta>
):RecyclerView.Adapter<Rcv_CuentaOrganizacion.myVewHolder>() {
    inner class myVewHolder(view: View): RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        override fun onClick(item: View?) {
            val intent = Intent(context, InformacionCuentaEmpresa::class.java)
